...
class COCODetection(DatasetSplit):
    ...
    _INSTANCE_TO_BASEDIR = {
        'train2014': 'JPEGImages',
        'val2014': 'JPEGImages',
        'minitrain2014': 'JPEGImages',
        'minival2014': 'JPEGImages',
    }
    ...
    def __init__(self, basedir, split):
        ...
        annotation_file = os.path.join(
            basedir, 'mscoco_format/annotations/instances_{}.json'.format(split))
    ...
    def _add_detection_gt(self, img, add_mask):
        ...
        # clean-up boxes
        width = img['width'] #img.pop('width')
        height = img['height'] #img.pop('height')
            ...
            if obj['area'] > 1 and w > 0 and h > 0:
                ...
                if add_mask:
                    ...
                    if not isinstance(segs, list):
                        ...
                        if len(valid_segs) == 0:
                            print("Object {} in image {} has no valid polygons!".format(objid, img['file_name']))
                        elif len(valid_segs) < len(segs):
                            print("Object {} in image {} has invalid polygons!".format(objid, img['file_name']))
...
if __name__ == '__main__':
    basedir = '/media/ubuntu/Working/voc2012/VOC2012/'
